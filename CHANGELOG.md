...
- Commands: `count`, `outline`, `histogram`, `rhythm`, `freq`, `unique`, `hapax`, `repeats`, `echoes`, `starters`, `tics`, `filter`, `hedges`, `adverbs`, `cliches`, `passive`, `overused`, `readability`, `dialogue`, `report`, `check`, `init`, `completions`.
